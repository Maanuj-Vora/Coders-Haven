...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/Coders-Haven/flexsearch.min.js');loadScript('/Coders-Haven/en.search-data.min.ca84b2dfeedd78b439ef18a8e52df90d34fca4e707c2244fdd13a22ffce57c3e.js',function(){input.required=false;search();});}
