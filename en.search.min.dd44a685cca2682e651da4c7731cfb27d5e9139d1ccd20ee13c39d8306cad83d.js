...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/Coders-Haven/flexsearch.min.js');loadScript('/Coders-Haven/en.search-data.min.9095e849cf2f65c8bc53c5bac37f113e00756610228d235adc86ee2b417807d7.js',function(){input.required=false;search();});}
