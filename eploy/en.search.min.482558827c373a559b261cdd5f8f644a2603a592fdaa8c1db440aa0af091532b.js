...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.902c1fb3d75a21a4bc0ba56a48171be92bea19b98379fb879cc4fba8071dd803.js',function(){input.required=false;search();});}
